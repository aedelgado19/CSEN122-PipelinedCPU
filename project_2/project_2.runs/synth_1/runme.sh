...
HD_PWD='C:/Users/ygoh2/CSEN122L/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_pipelined_cpu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_pipelined_cpu.tcl
